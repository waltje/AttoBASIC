...
#define configure_rx_pin()     UART_DDR &= ~(1 << UART_Rx)
#define configure_rx_pullup()  UART_Port |= (1 << UART_Rx)
#define configure_tx_pin()     UART_DDR |= (1 << UART_Tx)

#define set_tx_pin()    UART_Port |= (1 << UART_Tx)
#define clear_tx_pin()  UART_Port &= ~(1 << UART_Tx)
#define read_rx_pin()   PINB & (1 << PB2)
...
#define enable_rx_timer_interrupt()     TIMSK |= (1 << OCIE0A)
#define enable_tx_timer_interrupt()     TIMSK |= (1 << OCIE0B)
#define enable_external_interrupt()     GIMSK |= (1 << INT0)
#define disable_rx_timer_interrupt()    TIMSK &= ~(1 << OCIE0A)
#define disable_tx_timer_interrupt()    TIMSK &= ~(1 << OCIE0B)
#define disable_external_interrupt()    GIMSK &= ~(1 << INT0)
#define reset_rx_interrupt_flag()       TIFR |= (1 << OCF0A)
#define reset_tx_interrupt_flag()       TIFR |= (1 << OCF0B)
#define reset_external_interrupt_flag() GIFR |= (1 << INTF0)
